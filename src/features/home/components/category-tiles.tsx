          ...
          {HOME_CATEGORIES.map((c) => (
            ...
            >
              <CldImage
                ...
                alt={c.label}
                fill
                sizes="(max-width: 640px) 140px, (max-width: 1024px) 50vw, 50vw"
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-4 text-white sm:p-6 lg:p-5">
                <div className="translate-y-0 lg:translate-y-4 transition-transform duration-700 group-hover:translate-y-0">
                  ...
                  {/* Expanding link with arrow (Desktop only) */}
                  <div className="hidden lg:grid grid-rows-[0fr] opacity-0 transition-all duration-700 group-hover:grid-rows-[1fr] group-hover:opacity-100">
